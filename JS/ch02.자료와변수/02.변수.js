...
// PI = 3.14; // 상수에 값을 할당하면 에러 발생

// 변수 - 전역변수(var), 로컬변수(let)
let = 5;       // 변수는 프로그램 내에서 얼마든지 값이 변경될 수 있다.
...
// 증감 연산자
let x = 0, y = 0;
console.log(x++, ++y);  // post-increment(조회후 1 증가), pre-increment(조회전 1증가)
console.log(x, y);
...
console.log(String('123'), typeof String(123), typeof(Number("237")), typeof(String(123)), '<- typeof function');
